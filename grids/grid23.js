...
for (var square = 0; square < 16; square++) {
	grid.append("text")
		.text(function (d) { if(square == 0| square == 5 ) {return "2" } if (square == 10) {return "11" } if(square == 1|square == 9|square == 14) {return "-1" } if (square == 15) {return "-100"} else {return "0"}})
