...
var blue_counter = 240;
var yellow_counter = 2; 
var x_start = 91; 
var y_start = 11; 
...
var column = row.selectAll(".square")
  ...
  //  })
	...
	.style("fill", function (d){
		if (d.text == "blue") {return d.text}
		else if (d.row == 16 & d.column <=12) { return d.text}
