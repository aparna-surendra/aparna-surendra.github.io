...
for (var square = 0; square < 16; square++) {
	grid.append("text")
		.text(function (d) { if(square == 0| square == 5 |square == 10) {return "0.5" } if(square == 1|square == 9|square == 14) {return "- 0.5" } if (square == 15) {return "5"} else {return "0"}})
...
var grid4 = d3.select("#grid13")
	.append("svg")
	.attr("width","500px")
	.attr("height","220px");

grid4.append("text")
	.text("After 1 training episode (r_s15 = +10)")
	.attr("x", 5)
	.attr("y", 215)
	.style("font-weight", "bold")
